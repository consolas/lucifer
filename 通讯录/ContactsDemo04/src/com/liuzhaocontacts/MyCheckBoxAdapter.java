...
//        Log.i("SectionIndics", sectionContentArray.get(i));
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
    	...
    	if(convertView == null){
    		//初始化布局文件和布局的组建结构
    		convertView = this.mInflater.inflate(R.layout.contacts_item, null);
    		...
    		holder.cb.setOnCheckedChangeListener(new OnCheckedChangeListener(){
				...
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
					...
					//如果选中了
					if (isChecked == true) {
						if(checkedCount >= ContactsDemo04Activity.maxCheckCount){
							print("checkedCount = "+ checkedCount);
							//如果弹出过，则不弹出新的提示框
							if(alert == null){
								alert = new AlertDialog.Builder(myContext)
								.setTitle("提示")
								.setMessage("您一次最多能选择"+ContactsDemo04Activity.maxCheckCount+"个联系人")
