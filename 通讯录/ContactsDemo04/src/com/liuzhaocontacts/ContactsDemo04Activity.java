...
public class ContactsDemo04Activity extends Activity{
		//最大可选择的联系人数目
    ...
    private Handler handler = new Handler() {
    	...
    	public void handleMessage(Message msg) {
    		...
    		case HTTP_REQUEST_OK:
    			...
    			Toast.makeText(ContactsDemo04Activity.this, "发送成功", Toast.LENGTH_SHORT).show();
    			break;
			default:
				break;
    		}
    ...
    public boolean recommendContacts(String msg){
		try {
			...
			if((recommendDialog == null) || (!recommendDialog.isShowing())){
				...
				//srThread.start();
				Log.i("Contacts", msg);
				ContactsDemo04Activity.this.handler.sendEmptyMessage(HTTP_REQUEST_OK);
			}
			return true;
		} catch (Exception e) {
			e.printStackTrace();
